...
//             var city = strings[2];
//             
//             yield return ($"('{firstName}', '{secondName}', {age}, '', '{city}', '', '')");
//         }
//     }
//
...
//             
//             var sql = $"""
// INSERT INTO "Users"("FirstName", "SecondName", "Age", "Biography", "CityId", "Password", "Salt")
// (
//     SELECT
//         t."FirstName",
//         t."SecondName",
...
//         t."Password",
//         t."Salt"
//     FROM (VALUES {string.Join($",{Environment.NewLine}", values)}) AS t ("FirstName", "SecondName", "Age", "Biography", "City", "Password", "Salt")
